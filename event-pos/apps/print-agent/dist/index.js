...
function getDefaultSystemPrinter() {
    ...
    try {
        if (isWin) {
            ...
            const outPos = (0, child_process_1.execSync)(cmdPos, { encoding: 'utf8', timeout: 3000 }).trim();
            if (outPos)
                return outPos;
            ...
            const outAny = (0, child_process_1.execSync)(cmdAny, { encoding: 'utf8', timeout: 3000 }).trim();
            return outAny || null;
        }
        else {
            // macOS / Linux CUPS
            ...
            const eOut = (0, child_process_1.execSync)('lpstat -e 2>/dev/null || true', { encoding: 'utf8', timeout: 3000 });
